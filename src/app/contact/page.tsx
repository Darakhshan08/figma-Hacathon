          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="flex items-start gap-4">
                <div className="p-3 bg-[#5726DF] rounded-full w-11 h-11 flex-shrink-0">
                ...
                <div>
                  ...
                  <p className="text-[#8A8FB9] font-semibold text-base ">E-Mail: shop@store.com</p>
                </div>
              </div>

              <div className="flex items-start gap-4">
                <div className="p-3 bg-[#FB2E86] rounded-full w-11 h-11 flex-shrink-0">
                ...
                <div>
                  ...
                  <p className="text-[#8A8FB9] font-semibold text-base">For over 24hr</p>
                </div>
              </div>

              <div className="flex items-start gap-4">
                <div className="p-3 bg-[#FFB265] rounded-full w-11 h-11 flex-shrink-0">
                ...
                <div>
                  ...
                  <p className="text-[#8A8FB9] font-semibold text-base">Great britain, 3NM98-LK</p>
                </div>
              </div>

              <div className="flex items-start gap-4">
                <div className="p-3 bg-[#1BE982] rounded-full w-11 h-11 flex-shrink-0">
                ...
                <div>
                  ...
                  <p className="text-[#8A8FB9] font-semibold text-base">on all orders.</p>
                </div>
              </div>
            </div>
          </section>
        ...
        <section className="grid md:grid-cols-2 gap-8 mt-16">
          <div className="relative z-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                type="submit"
                className="bg-[#FB2E86] text-white px-12 py-4 rounded-[3px] hover:bg-[#ff0077] 
          ...
          <div className="hidden md:block relative">
            {/* <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-[500px] h-[500px] border-2 border-blue-100 rounded-full absolute animate-spin-slow"></div>
                <div className="w-[400px] h-[400px] border-2 border-blue-100 rounded-full absolute"></div>
                <div className="w-[300px] h-[300px] border-2 border-blue-100 rounded-full absolute"></div>
              </div> */}
            <div className="relative z-10 flex items-center justify-center h-full">
              <Image
                ...
                priority // Optional: Helps in preloading critical images
              />
            </div>
          </div>
        </section>
